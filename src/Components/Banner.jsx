const Banner = () => {
  return (
    <div
      className="w-[1160px] mx-auto h-[441px] mt-10 bg-opacity-10"
      style={{
        backgroundImage: "url(https://i.ibb.co/M54hsn8/Rectangle-8.png)",
      }}
    >
      <div className=" flex h-full ml-28 font-normal text-white justify-start items-center">
        <div className="max-w-md">
          ...
          <div className="flex space-x-3">
            ...
            <button className="py-2 px-4 rounded-lg border-white border-[1px]">
              Explore All Events
            </button>
          </div>
        </div>
