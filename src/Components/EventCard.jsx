  ...
  return (
    <div className="w-[373px] bg-[#F1F3FF] py-5 rounded-2xl relative ">
      ...
      <div className="flex justify-between px-5">
        <div>
          <div>
            <p className="px-3 py-1 w-16 text-white rounded-md bg-gradient-to-r text-sm from-[#7342F9] to-[#8053FA]">
              Music
            </p>
          </div>
          <div className="flex space-x-2 my-3">
            {" "}
            <img
              src="https://i.ibb.co/xGPmxBb/Vectorlocation.png"
              alt="location"
            />{" "}
            <span className="text-xs">Celebrity Convention Hall</span>
          </div>
      ...
      <div className="flex space-x-2 px-5">
        <button className="text-white bg-gradient-to-r from-[#7342F9] to-[#8053FA] flex justify-center items-center py-2 px-2 rounded-lg">
          <img
            className="mr-3"
            src="https://i.ibb.co/NtN6bs3/Vector.png"
            alt="icon"
          />
          See Ticket
        </button>
